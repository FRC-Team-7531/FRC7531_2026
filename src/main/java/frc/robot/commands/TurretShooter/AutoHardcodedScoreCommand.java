...
public class AutoHardcodedScoreCommand extends Command {
  SS_Turret turret;
  SS_Shooter shooter;
  ...
  public AutoHardcodedScoreCommand(SS_Turret ss_turret, SS_Shooter ss_shooter, SS_Drivetrain ss_drivetrain) {
