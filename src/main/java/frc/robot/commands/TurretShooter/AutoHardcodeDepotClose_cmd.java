...
public class AutoHardcodeDepotClose_cmd extends Command {
  ...
  public AutoHardcodeDepotClose_cmd(SS_Turret ss_turret, SS_Shooter ss_shooter, SS_Drivetrain ss_drivetrain) {
