...
public class AutoHardcodeDepotCommand extends Command {
  ...
  public AutoHardcodeDepotCommand(SS_Turret ss_turret, SS_Shooter ss_shooter, SS_Drivetrain ss_drivetrain) {
  ...
  public void execute() {
    ...
    shooter.setSpeed(7.946 / 9);

    shooter.hoodLifter.setPosition(0.29);
  }
