...
public class AutoHardcodeDepotCloseCommand extends Command {
  //Hardcode for auto closer Depot spot
  ...
  public AutoHardcodeDepotCloseCommand(SS_Turret ss_turret, SS_Shooter ss_shooter, SS_Drivetrain ss_drivetrain) {
  ...
  public void execute() {
    ...
    shooter.setSpeed(6.121 / 9);

    shooter.hoodLifter.setPosition(0.09);
  }
